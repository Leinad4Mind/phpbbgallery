...
| Add-on | Version | Description |
| --- | --- | --- |
| Remote Storage | 1.0.0 | Stores private Gallery objects in S3-compatible, Azure Blob, SFTP, Dropbox, Google Drive or Box storage with verified, resumable provider migrations. |
