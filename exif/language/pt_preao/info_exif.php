...
$lang = array_merge($lang, [
	...
	'EXIF_EXPOSURE_PROG_6'     => 'Programa de Acção (favorece velocidade do obturador alta)',
	...
	'EXIF_FLASH_CASE_5'        => 'luz de retorno não detectada',
	'EXIF_FLASH_CASE_7'        => 'luz de retorno detectada',
	'EXIF_FLASH_CASE_8'        => 'Ligado, Flash não disparou',
	'EXIF_FLASH_CASE_9'        => 'Flash disparou, modo flash forçado',
	'EXIF_FLASH_CASE_13'       => 'Flash disparou, modo flash forçado, luz de retorno não detectada',
	'EXIF_FLASH_CASE_15'       => 'Flash disparou, modo flash forçado, luz de retorno detectada',
	'EXIF_FLASH_CASE_16'       => 'Flash não disparou, modo flash forçado',
	'EXIF_FLASH_CASE_20'       => 'Desligado, Flash não disparou, luz de retorno não detectada',
	'EXIF_FLASH_CASE_24'       => 'Flash não disparou, modo auto',
	'EXIF_FLASH_CASE_25'       => 'Flash disparou, modo auto',
	'EXIF_FLASH_CASE_29'       => 'Flash disparou, modo auto, luz de retorno não detectada',
	'EXIF_FLASH_CASE_31'       => 'Flash disparou, modo auto, luz de retorno detectada',
	...
	'EXIF_FLASH_CASE_69'       => 'Flash disparou, modo redução de olhos vermelhos, luz de retorno não detectada',
	'EXIF_FLASH_CASE_71'       => 'Flash disparou, modo redução de olhos vermelhos, luz de retorno detectada',
	'EXIF_FLASH_CASE_73'       => 'Flash disparou, modo flash forçado, redução de olhos vermelhos',
	'EXIF_FLASH_CASE_77'       => 'Flash disparou, modo flash forçado, redução de olhos vermelhos, luz de retorno não detectada',
	'EXIF_FLASH_CASE_79'       => 'Flash disparou, modo flash forçado, redução de olhos vermelhos, luz de retorno detectada',
	...
	'EXIF_FLASH_CASE_93'       => 'Flash disparou, modo auto, luz de retorno não detectada, redução de olhos vermelhos',
	'EXIF_FLASH_CASE_95'       => 'Flash disparou, modo auto, luz de retorno detectada, redução de olhos vermelhos',
	...
	'DISP_EXIF_DATA_EXPLAIN' => 'Activa globalmente a apresentação de EXIF. Quando desactivada, as escolhas EXIF da página individual da imagem e dos cartões de miniaturas são ignoradas.',
	'EXIF_IMAGE_PAGE_FIELD_EXPLAIN' => 'Controla este valor apenas na página individual da imagem. Para o apresentar sob miniaturas, selecciona-o separadamente na definição de informações dos cartões correspondente.',
