...
$lang = array_merge($lang, [
	...
	'EXIF_RESOLUTION'			=> 'Densità di risoluzione',
	...
	'DISP_EXIF_DATE'      => 'Mostra “Immagine scattata il”',
	'DISP_EXIF_FOCAL'     => 'Mostra lunghezza focale',
	'DISP_EXIF_EXPOSURE'  => 'Mostra tempo di posa',
	'DISP_EXIF_APERTURE'  => 'Mostra apertura',
	'DISP_EXIF_ISO'       => 'Mostra sensibilità ISO',
	'DISP_EXIF_WHITEB'    => 'Mostra bilanciamento del bianco',
	'DISP_EXIF_FLASH'     => 'Mostra flash',
	'DISP_EXIF_CAM_MODEL' => 'Mostra modello della fotocamera',
	'DISP_EXIF_RESOLUTION' => 'Mostra densità di risoluzione',
	'DISP_EXIF_EXPOSURE_PROG' => 'Mostra programma di esposizione',
	'DISP_EXIF_EXPOSURE_BIAS' => 'Mostra compensazione dell’esposizione',
	'DISP_EXIF_METERING_MODE' => 'Mostra modalità di misurazione',
	...
	'ACP_GALLERY_EXIF'           => 'Metadati EXIF',
	'ACP_GALLERY_EXIF_EXPLAIN'   => 'Gestisce le date di acquisizione indicizzate usate per ordinare la Galleria.',
	'ACP_EXIF_CAPTURE_INDEX'     => 'Indice delle date di acquisizione',
	'ACP_EXIF_INDEXED_IMAGES'    => 'Immagini con data di acquisizione indicizzata',
	'ACP_EXIF_SYNC_EXPLAIN'      => 'Ricostruisce l’indice dai metadati EXIF salvati e, quando necessario, dai file JPEG originali. L’operazione usa piccoli lotti ripristinabili.',
	'DISP_EXIF_DATA_EXPLAIN' => 'Abilita globalmente la visualizzazione EXIF. Se disattivata, le selezioni EXIF per la pagina della singola immagine e per le schede delle miniature vengono ignorate.',
	'EXIF_IMAGE_PAGE_FIELD_EXPLAIN' => 'Controlla questo valore solo nella pagina della singola immagine. Per mostrarlo sotto le miniature, selezionalo separatamente nell’impostazione delle informazioni delle schede pertinente.',
	'ACP_EXIF_SYNC_CONFIRM'      => 'Vuoi davvero ricostruire l’indice delle date EXIF?',
	'ACP_EXIF_SYNC_PROGRESS'     => 'Sincronizzazione EXIF in corso: %1$d immagini analizzate, %2$d date indicizzate e %3$d file sorgente temporaneamente non disponibili.',
	'ACP_EXIF_SYNC_COMPLETE'     => 'Sincronizzazione EXIF completata: %1$d immagini analizzate, %2$d date indicizzate e %3$d file sorgente non disponibili.',
]);
