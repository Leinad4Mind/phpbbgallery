...
namespace
{
	...
	require_once $gallery_root . '/core/storage/provider_interface.php';
	require_once $gallery_root . '/core/storage/local_object.php';
	require_once $gallery_root . '/core/storage/local_provider.php';
