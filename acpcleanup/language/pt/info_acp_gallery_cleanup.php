...
$lang = array_merge($lang, [
	...
	'SOURCE_CHECK_PROGRESS' => 'A verificar os ficheiros source da Galeria',
	'SOURCE_CHECK_COMPLETE' => 'Verificação dos ficheiros source concluída',
	'SOURCE_CHECK_RESULT' => 'Verificados: %1$d; ficheiros source em falta: %2$d.',
	'SOURCE_CHECK_RUN' => 'Verificar novamente os ficheiros source',
	'MISSING_SOURCE_DIAGNOSTIC_EXPLAIN' => 'Este diagnóstico verifica o provider de armazenamento ativo em lotes retomáveis de 25. A falta de ficheiros medium ou mini não torna o registo inválido, pois esses derivados podem ser regenerados a partir do source.',
	'MISSING_SOURCE_SUMMARY' => 'Existem %1$d registos sem ficheiro source no provider ativo %2$s.',
	'MISSING_SOURCE_CONTEXT' => 'Álbum e autor',
	'MISSING_SOURCE_EXPECTED_KEY' => 'Objeto source esperado',
	'MISSING_SOURCE_DERIVATIVES' => 'Derivados existentes',
	'MISSING_SOURCE_MEDIUM' => 'Medium',
	'MISSING_SOURCE_MINI' => 'Mini',
	'MISSING_SOURCE_RESTORE_EXPLAIN' => 'Restaura os originais recuperáveis no provider e na chave source exatos indicados acima e volta a executar a verificação. Seleciona e elimina apenas os registos cujos originais não possam ser recuperados; a eliminação é confirmada e utiliza a limpeza de domínio da Galeria para manter coerentes os contadores e os dados relacionados.',
	'MISSING_SOURCE_STATUS_UNAPPROVED' => 'A aguardar aprovação',
	'MISSING_SOURCE_STATUS_APPROVED' => 'Aprovada',
	'MISSING_SOURCE_STATUS_LOCKED' => 'Bloqueada',
	'MISSING_SOURCE_STATUS_ORPHAN' => 'Upload por concluir',
	'MISSING_SOURCE_STATUS_DELETE_REQUESTED' => 'Eliminação solicitada',
	'MISSING_SOURCE_STATUS_UNKNOWN' => 'Desconhecido',
	...
	'GALLERY_LEGACY_BBCODE_MIGRATE_EXPLAIN' => 'Procura o alias oculto [album] em mensagens, mensagens privadas e assinaturas. Após confirmação, cada execução reprocessa até %1$d registos para %2$s e mantém coerentes os metadados dos BBCodes do phpBB. Repete a ação até não restarem registos.',
	'GALLERY_LEGACY_BBCODE_MIGRATE_CONFIRM' => 'Converter o próximo lote de [album] para %2$s? Restam atualmente %1$d registos.',
