...
$lang = array_merge($lang, [
	...
	'GALLERY_LEGACY_BBCODE_MIGRATE_EXPLAIN' => 'Търси скрития псевдоним [album] в публикации, лични съобщения и подписи. След потвърждение всяко изпълнение обработва до 250 записа като %s и поддържа съгласувани BBCode метаданните на phpBB. Повтаряйте действието, докато не останат записи.',
