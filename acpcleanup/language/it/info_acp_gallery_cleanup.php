...
$lang = array_merge($lang, [
	...
	'SOURCE_CHECK_PROGRESS' => 'Verifica dei file sorgente della Galleria',
	'SOURCE_CHECK_COMPLETE' => 'Verifica dei file sorgente completata',
	'SOURCE_CHECK_RESULT' => 'Verificati: %1$d; file sorgente mancanti: %2$d.',
	'SOURCE_CHECK_RUN' => 'Verifica nuovamente i file sorgente',
	'MISSING_SOURCE_DIAGNOSTIC_EXPLAIN' => 'Questa diagnostica controlla il provider di archiviazione attivo in gruppi riprendibili di 25. File medium o mini mancanti non rendono non valido un record, perché tali derivati possono essere rigenerati dal sorgente.',
	'MISSING_SOURCE_SUMMARY' => '%1$d record non hanno il file sorgente nel provider attivo %2$s.',
	'MISSING_SOURCE_CONTEXT' => 'Album e autore',
	'MISSING_SOURCE_EXPECTED_KEY' => 'Oggetto sorgente previsto',
	'MISSING_SOURCE_DERIVATIVES' => 'Derivati esistenti',
	'MISSING_SOURCE_MEDIUM' => 'Medium',
	'MISSING_SOURCE_MINI' => 'Mini',
	'MISSING_SOURCE_RESTORE_EXPLAIN' => 'Ripristina gli originali recuperabili nel provider e nella chiave sorgente esatti indicati sopra, quindi ripeti la verifica. Seleziona ed elimina solo i record i cui originali non possono essere recuperati; la cancellazione richiede conferma e mantiene coerenti i dati correlati.',
	'MISSING_SOURCE_STATUS_UNAPPROVED' => 'In attesa di approvazione',
	'MISSING_SOURCE_STATUS_APPROVED' => 'Approvata',
	'MISSING_SOURCE_STATUS_LOCKED' => 'Bloccata',
	'MISSING_SOURCE_STATUS_ORPHAN' => 'Caricamento incompleto',
	'MISSING_SOURCE_STATUS_DELETE_REQUESTED' => 'Cancellazione richiesta',
	'MISSING_SOURCE_STATUS_UNKNOWN' => 'Sconosciuto',
	...
	'GALLERY_LEGACY_BBCODE_MIGRATE' => 'Migra i BBCode precedenti della galleria',
	'GALLERY_LEGACY_BBCODE_MIGRATE_EXPLAIN' => 'Cerca l’alias nascosto [album] nei messaggi, nei messaggi privati e nelle firme. Dopo la conferma, ogni esecuzione rielabora fino a %1$d record come %2$s e mantiene coerenti i metadati BBCode di phpBB. Ripeti l’azione finché non rimangono record.',
	'GALLERY_LEGACY_BBCODE_MIGRATE_CONFIRM' => 'Convertire il prossimo gruppo da [album] a %2$s? Attualmente restano %1$d record.',
	'GALLERY_LEGACY_BBCODE_MIGRATE_NONE' => 'Non restano record precedenti con [album].',
	'GALLERY_LEGACY_BBCODE_MIGRATE_RESULT' => 'Sono stati convertiti %1$d record. Non è stato possibile convertire %2$d record. Restano %3$d record.',
