...
$lang = array_merge($lang, [
	...
	'MISSING_SOURCE_DIAGNOSTIC_EXPLAIN' => 'Este diagnóstico verifica o provider de armazenamento activo em lotes retomáveis de 25. A falta de ficheiros medium ou mini não torna o registo inválido, pois esses derivados podem ser regenerados a partir do source.',
	'MISSING_SOURCE_SUMMARY' => 'Existem %1$d registos sem ficheiro source no provider activo %2$s.',
	'MISSING_SOURCE_CONTEXT' => 'Álbum e autor',
	'MISSING_SOURCE_EXPECTED_KEY' => 'Objecto source esperado',
	'MISSING_SOURCE_DERIVATIVES' => 'Derivados existentes',
	'MISSING_SOURCE_MEDIUM' => 'Medium',
	'MISSING_SOURCE_MINI' => 'Mini',
	'MISSING_SOURCE_RESTORE_EXPLAIN' => 'Restaura os originais recuperáveis no provider e na chave source exactos indicados acima e volta a executar a verificação. Selecciona e elimina apenas os registos cujos originais não possam ser recuperados; a eliminação é confirmada e utiliza a limpeza de domínio da Galeria para manter coerentes os contadores e os dados relacionados.',
	...
	'GALLERY_LEGACY_BBCODE_MIGRATE_EXPLAIN' => 'Procura o alias oculto [album] em mensagens, mensagens privadas e assinaturas. Após confirmação, cada execução reprocessa até %1$d registos para %2$s e mantém coerentes os metadados dos BBCodes do phpBB. Repete a acção até não restarem registos.',
