...
$lang = array_merge($lang, [
	...
	'SOURCE_CHECK_PROGRESS' => 'Vérification des fichiers source de la Galerie',
	'SOURCE_CHECK_COMPLETE' => 'Vérification des fichiers source terminée',
	'SOURCE_CHECK_RESULT' => 'Vérifiés : %1$d ; fichiers source manquants : %2$d.',
	'SOURCE_CHECK_RUN' => 'Vérifier à nouveau les fichiers source',
	'MISSING_SOURCE_DIAGNOSTIC_EXPLAIN' => 'Ce diagnostic vérifie le fournisseur de stockage actif par lots reprenables de 25. Des fichiers medium ou mini manquants ne rendent pas un enregistrement invalide, car ces dérivés peuvent être régénérés depuis la source.',
	'MISSING_SOURCE_SUMMARY' => '%1$d enregistrements sont dépourvus de fichier source chez le fournisseur actif %2$s.',
	'MISSING_SOURCE_CONTEXT' => 'Album et auteur',
	'MISSING_SOURCE_EXPECTED_KEY' => 'Objet source attendu',
	'MISSING_SOURCE_DERIVATIVES' => 'Dérivés existants',
	'MISSING_SOURCE_MEDIUM' => 'Medium',
	'MISSING_SOURCE_MINI' => 'Mini',
	'MISSING_SOURCE_RESTORE_EXPLAIN' => 'Restaurez les originaux récupérables dans le fournisseur et sous la clé source exacts indiqués ci-dessus, puis relancez la vérification. Ne sélectionnez et supprimez que les enregistrements dont les originaux sont irrécupérables ; la suppression est confirmée et préserve la cohérence des données liées.',
	'MISSING_SOURCE_STATUS_UNAPPROVED' => 'En attente d’approbation',
	'MISSING_SOURCE_STATUS_APPROVED' => 'Approuvée',
	'MISSING_SOURCE_STATUS_LOCKED' => 'Verrouillée',
	'MISSING_SOURCE_STATUS_ORPHAN' => 'Envoi inachevé',
	'MISSING_SOURCE_STATUS_DELETE_REQUESTED' => 'Suppression demandée',
	'MISSING_SOURCE_STATUS_UNKNOWN' => 'Inconnu',
