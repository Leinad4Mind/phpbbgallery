...
$lang = array_merge($lang, [
	...
	'SOURCE_CHECK_PROGRESS' => 'Verificando os arquivos source da Galeria',
	'SOURCE_CHECK_COMPLETE' => 'Verificação dos arquivos source concluída',
	'SOURCE_CHECK_RESULT' => 'Verificados: %1$d; arquivos source ausentes: %2$d.',
	'SOURCE_CHECK_RUN' => 'Verificar novamente os arquivos source',
	'MISSING_SOURCE_DIAGNOSTIC_EXPLAIN' => 'Este diagnóstico verifica o provider de armazenamento ativo em lotes retomáveis de 25. A ausência de arquivos medium ou mini não torna o registro inválido, pois esses derivados podem ser regenerados a partir do source.',
	'MISSING_SOURCE_SUMMARY' => 'Existem %1$d registros sem arquivo source no provider ativo %2$s.',
	...
	'MISSING_SOURCE_RESTORE_EXPLAIN' => 'Restaure os originais recuperáveis no provider e na chave source exatos indicados acima e execute a verificação novamente. Selecione e exclua apenas os registros cujos originais não possam ser recuperados; a exclusão é confirmada e usa a limpeza de domínio da Galeria para manter consistentes os contadores e os dados relacionados.',
	'MISSING_SOURCE_STATUS_UNAPPROVED' => 'Aguardando aprovação',
	'MISSING_SOURCE_STATUS_APPROVED' => 'Aprovada',
	'MISSING_SOURCE_STATUS_LOCKED' => 'Bloqueada',
	'MISSING_SOURCE_STATUS_ORPHAN' => 'Upload não concluído',
	'MISSING_SOURCE_STATUS_DELETE_REQUESTED' => 'Exclusão solicitada',
	...
	'GALLERY_LEGACY_BBCODE_MIGRATE_EXPLAIN' => 'Procura o alias oculto [album] em posts, mensagens privadas e assinaturas. Após a confirmação, cada execução reprocessa até %1$d registros para %2$s e mantém consistentes os metadados dos BBCodes do phpBB. Repita a ação até não restarem registros.',
