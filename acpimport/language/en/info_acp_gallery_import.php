...
$lang = array_merge($lang, [
	...
	'IMPORT_ARCHIVES'            => 'ZIP archives',
	'IMPORT_ARCHIVES_SELECT'     => 'Choose the archives you want to unpack. Their images are placed in the import folder, where you can then select the ones you want to import. Unpacked archives are deleted.',
	'IMPORT_EXTRACT'             => 'Extract',
	'IMPORT_NO_ARCHIVES'         => 'There are no ZIP archives in the import folder.',
	'IMPORT_ZIP_ALL_EXTRACTED'   => '%1$d images were extracted from %2$d archives. Select the ones you want to import below.',
	'IMPORT_ZIP_EXTRACTED'       => '%1$d images extracted from “%2$s”.',
	'IMPORT_ZIP_FAILED'          => 'The archive “%s” could not be extracted.',
	'IMPORT_ZIP_MAX_IMAGES'      => 'Images per archive',
	'IMPORT_ZIP_MAX_IMAGES_EXPLAIN' => 'How many images a single archive may yield. An archive is never read beyond 1000 entries, so that is also the highest useful value.',
	'IMPORT_ZIP_SETTINGS'        => 'ZIP archives',
	'IMPORT_ZIP_SETTINGS_SAVED'  => 'The archive settings were saved.',
	...
	'IMPORT_INVALID_IMAGE'       => 'The selected file “%s” is not a permitted image from the import folder.',
	'IMPORT_SCHEMA_WRITE_FAILED' => 'The import state could not be stored safely.',
	'IMPORT_TOO_MANY_IMAGES'     => 'You can import at most %d images at a time.',
	'IMPORT_UNREADABLE_FILES'    => '%d files with unreadable names were ignored.',
