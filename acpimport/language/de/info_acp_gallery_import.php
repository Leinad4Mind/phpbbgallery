...
$lang = array_merge($lang, [
	...
	'IMPORT_ARCHIVES'            => 'ZIP-Archive',
	'IMPORT_ARCHIVES_SELECT'     => 'Wähle die Archive aus, die entpackt werden sollen. Ihre Bilder landen im Import-Ordner, wo du anschließend auswählen kannst, welche importiert werden. Entpackte Archive werden gelöscht.',
	'IMPORT_EXTRACT'             => 'Entpacken',
	'IMPORT_NO_ARCHIVES'         => 'Im Import-Ordner liegen keine ZIP-Archive.',
	'IMPORT_ZIP_ALL_EXTRACTED'   => 'Es wurden %1$d Bilder aus %2$d Archiven entpackt. Wähle unten aus, welche importiert werden sollen.',
	'IMPORT_ZIP_EXTRACTED'       => '%1$d Bilder aus „%2$s“ entpackt.',
	'IMPORT_ZIP_FAILED'          => 'Das Archiv „%s“ konnte nicht entpackt werden.',
	'IMPORT_ZIP_MAX_IMAGES'      => 'Bilder pro Archiv',
	'IMPORT_ZIP_MAX_IMAGES_EXPLAIN' => 'Wie viele Bilder ein einzelnes Archiv liefern darf. Ein Archiv wird nie über 1000 Einträge hinaus gelesen, mehr ist also nicht sinnvoll.',
	'IMPORT_ZIP_SETTINGS'        => 'ZIP-Archive',
	'IMPORT_ZIP_SETTINGS_SAVED'  => 'Die Archiv-Einstellungen wurden gespeichert.',
