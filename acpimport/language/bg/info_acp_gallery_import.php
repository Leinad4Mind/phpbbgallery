...
$lang = array_merge($lang, [
	...
	'IMPORT_ARCHIVES'            => 'ZIP архиви',
	'IMPORT_ARCHIVES_SELECT'     => 'Изберете архивите, които искате да разархивирате. Изображенията им се поставят в папката за внасяне, откъдето след това можете да изберете кои да внесете. Разархивираните архиви се изтриват.',
	'IMPORT_EXTRACT'             => 'Разархивиране',
	'IMPORT_NO_ARCHIVES'         => 'В папката за внасяне няма ZIP архиви.',
	'IMPORT_ZIP_ALL_EXTRACTED'   => 'Разархивирани са %1$d изображения от %2$d архива. Изберете по-долу кои да бъдат внесени.',
	'IMPORT_ZIP_EXTRACTED'       => 'Разархивирани са %1$d изображения от „%2$s“.',
	'IMPORT_ZIP_FAILED'          => 'Архивът „%s“ не можа да бъде разархивиран.',
	'IMPORT_ZIP_MAX_IMAGES'      => 'Изображения на архив',
	'IMPORT_ZIP_MAX_IMAGES_EXPLAIN' => 'Колко изображения може да даде един архив. Архив никога не се чете отвъд 1000 записа, така че това е и най-високата полезна стойност.',
	'IMPORT_ZIP_SETTINGS'        => 'ZIP архиви',
	'IMPORT_ZIP_SETTINGS_SAVED'  => 'Настройките на архивите бяха запазени.',
	...
	'IMPORT_INVALID_IMAGE'       => 'Избраният файл „%s“ не е разрешено изображение от папката за импортиране.',
	'IMPORT_SCHEMA_WRITE_FAILED' => 'Състоянието на импортирането не можа да бъде записано безопасно.',
	'IMPORT_TOO_MANY_IMAGES'     => 'Можете да импортирате най-много %d изображения наведнъж.',
	'IMPORT_UNREADABLE_FILES'    => 'Пренебрегнати са %d файла с нечетими имена.',
