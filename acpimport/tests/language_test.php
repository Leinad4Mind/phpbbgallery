...
class language_test extends TestCase
{
	private const EXPECTED_KEYS = [
		...
		'IMPORT_USERS_PEGA',
		'IMPORT_USER_EXP',
		'IMPORT_ZIP_ALL_EXTRACTED',
		'IMPORT_ZIP_EXTRACTED',
		'IMPORT_ZIP_FAILED',
		'IMPORT_ZIP_MAX_IMAGES',
		'IMPORT_ZIP_MAX_IMAGES_EXPLAIN',
		'IMPORT_ZIP_SETTINGS',
		'IMPORT_ZIP_SETTINGS_SAVED',
	...
	private function expected_placeholders(string $key): array
	{
		$placeholders = [
			...
			'IMPORT_ZIP_ALL_EXTRACTED' => ['%1$d', '%2$d'],
			'IMPORT_ZIP_EXTRACTED' => ['%1$d', '%2$s'],
			'IMPORT_ZIP_FAILED' => ['%s'],
