...
- Added a persistent close/reopen control to the New Core and add-on ACP guide without disabling the provenance accents or badges applied to individual settings.
