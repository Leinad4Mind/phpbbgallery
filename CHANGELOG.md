...
- Kept functional fixtures portable under strict MySQL and MariaDB by explicitly supplying required text fields and synchronized the complete lifecycle role with modern source and statistics permissions.
