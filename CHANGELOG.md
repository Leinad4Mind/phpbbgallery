...
- Stacked the optional copyable image ID above each Gallery card title in Classic, Cards and Futuristic layouts; when IDs are disabled, the title remains centred on its own without reserved space.
