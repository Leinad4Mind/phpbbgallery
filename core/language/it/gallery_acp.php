...
$lang = array_merge($lang, [
	...
	'GALLERY_ADDON_SETTINGS_LEGEND_EXPLAIN' => 'Un badge a stella identifica le opzioni del Core della Galleria aggiunte dopo la 3.4.0; un badge a puzzle identifica le opzioni fornite dai componenti aggiuntivi. I colori evidenziano entrambe le origini. Le opzioni precedenti del Core restano senza contrassegno. Seleziona un badge di origine per mostrare o nascondere le relative opzioni.',
	'GALLERY_ADDON_SETTINGS_LEGEND_EXPLAIN_SIMPLE' => 'I colori identificano le opzioni del Core della Galleria aggiunte dopo la 3.4.0 e quelle fornite dai componenti aggiuntivi. Le opzioni precedenti del Core restano senza contrassegno. Seleziona un badge di origine per mostrare o nascondere le relative opzioni.',
	'GALLERY_ADDON_SETTINGS_LEGEND_EXPLAIN_HIDDEN' => 'I badge, i colori e i contrassegni di origine dei campi sono disattivati. Usa i badge di origine qui sotto per mostrare o nascondere le opzioni di ogni origine, oppure scegli Semplice o Completa per ripristinarne l’identificazione visiva.',
