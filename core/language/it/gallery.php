...
$lang = array_merge($lang, [
	...
	'ALLOW_COMMENTS_ALL'               => 'Permetti commenti per tutte le immagini.',
	'ALLOW_COMMENTS_ARY'               => [
	...
	'PHP_SIZE_OVERRUN'      => 'Il server ha rifiutato questa immagine perché la dimensione del file supera il limite di caricamento PHP di %1$d %2$s. L’amministratore del server deve aumentare <code>upload_max_filesize</code> e, se necessario, <code>post_max_size</code> nel file <code>php.ini</code>.',
	'BBCODES'               => 'BBCode',
	...
	'COMMENTS'                => 'Commenti',
	'GALLERY_COMMENT_UNAVAILABLE' => 'I commenti non sono attualmente disponibili per questa immagine.',
	'GALLERY_RESULTS_HIDDEN'     => 'I risultati sono attualmente nascosti.',
	'GALLERY_PRIVATE_IMAGE_DESC' => '<strong>Immagine privata</strong> » La descrizione dell’immagine è attualmente nascosta.',
	'GALLERY_PRIVATE_USER'    => '<strong>Utente nascosto</strong>',
	'CONTINUE'                => 'Continua',
	...
	'REQUEST_IMAGE_DELETION'  => 'Richiedi eliminazione',
	'DOWNLOAD_SOURCE'         => 'Scarica l’immagine originale',
	'REQUEST_IMAGE_DELETION_CONFIRM' => 'Vuoi davvero richiedere l’eliminazione di questa immagine?',
	'IMAGE_DELETION_REQUESTED' => 'La richiesta di eliminazione dell’immagine è stata inviata alla moderazione.',
	...
	'GALLERY_STATISTICS' => 'Statistiche della galleria',
	'GALLERY_STATISTICS_EXPLAIN' => 'Classifiche complessive e annuali delle immagini e degli album che puoi visualizzare.',
	'STATISTICS_PERIOD' => 'Periodo',
	'STATISTICS_ALL_TIME' => 'Da sempre',
	'STATISTICS_LEGACY_PERIOD' => 'Dati storici: %1$s – prima del %2$s',
	'STATISTICS_PARTIAL_YEAR' => '%1$s (dal %2$s)',
	'STATISTICS_IMAGES' => 'Immagini',
	'STATISTICS_VIEWS' => 'Visualizzazioni',
	'STATISTICS_DOWNLOADS' => 'Download degli originali',
	'STATISTICS_UPLOADERS' => 'Autori delle immagini',
	'STATISTICS_MOST_VIEWED_IMAGES' => 'Immagini più visualizzate',
	'STATISTICS_MOST_DOWNLOADED_IMAGES' => 'Immagini più scaricate',
	'STATISTICS_TOP_UPLOADERS' => 'Utenti con più immagini',
	'STATISTICS_TOP_DOWNLOADERS' => 'Utenti con più download',
	'NO_STATISTICS_DATA' => 'Non sono disponibili dati per questo periodo.',
	'STATISTICS_ANNUAL_TRACKING_NOTICE' => 'La suddivisione annuale di visualizzazioni e download viene registrata dal %s. I totali complessivi possono includere attività precedenti.',
	'STATISTICS_LEGACY_TRACKING_NOTICE' => 'Questo periodo raggruppa visualizzazioni e download registrati prima del %s. I contatori storici non memorizzavano le date e quindi non possono essere suddivisi con precisione per anno.',
	'STATISTICS_DOWNLOADER_HISTORY_NOTICE' => 'I download storici non originariamente associati a un utente non possono essere attribuiti retroattivamente.',
	...
	'COPY_IMAGE_BBCODE'            => 'Copia BBCode immagine',
	'IMAGE_BBCODE_COPIED'          => 'BBCode immagine copiato',
	'IMAGE_LOCKED'                 => 'Spiacente, quest’immagine è bloccata. Non si può più commentare quest’immagine.',
	'IMAGE_NAME'                   => 'Nome immagine',
	'IMAGE_UPLOAD_TIME'            => 'Data di caricamento',
	'IMAGE_NOT_EXIST'              => 'Quest’immagine non esiste.',
	'HOTLINK_NOT_ALLOWED'          => 'I collegamenti diretti alle immagini non sono consentiti.',
	...
	'RESIZE_SOURCE_FILESIZE_EXPLAIN' => 'Quando il ridimensionamento è attivo, Gallery accetta un file originale fino a %1$s. L’immagine ridimensionata salvata non deve superare %2$s. Le impostazioni PHP <code>upload_max_filesize</code> e <code>post_max_size</code> possono imporre un limite inferiore.',
	...
	'MOST_VIEWED_IMAGES' => 'Immagini più viste',
	...
	'PERSONAL_ALBUM_IMAGES'  => 'Immagini degli album personali',
	'REPORT_IMAGE'      => 'Segnala immagine',
	'RETURN_ALBUM'      => '%sTorna all’ultimo album visitato%s',
	'APPLY_TRANSFORM_ALL' => 'Applica questa trasformazione a tutte le immagini',
	'FLIP_HORIZONTAL' => 'Rifletti orizzontalmente', 'FLIP_VERTICAL' => 'Rifletti verticalmente',
	'IMAGE_TRANSFORM_ANIMATED_UNSUPPORTED' => 'I file GIF animati non possono essere trasformati senza perdere l’animazione.',
	'IMAGE_TRANSFORM_FAILED' => 'Non è stato possibile trasformare l’immagine “%s”. Nessuna modifica è stata salvata per questa immagine.',
	'IMAGE_TRANSFORM_FUNCTION' => 'Il server non dispone delle funzioni GD necessarie per trasformare questa immagine.',
	'ORIENTATION_1' => 'Orientamento originale', 'ORIENTATION_2' => 'Riflessa orizzontalmente', 'ORIENTATION_3' => 'Ruotata di 180°', 'ORIENTATION_4' => 'Riflessa verticalmente',
	'ORIENTATION_5' => 'Ruotata a destra e riflessa', 'ORIENTATION_6' => 'Ruotata a destra', 'ORIENTATION_7' => 'Ruotata a sinistra e riflessa', 'ORIENTATION_8' => 'Ruotata a sinistra',
	'TRANSFORM_IMAGE' => 'Trasforma immagine', 'TRANSFORM_RESET' => 'Ripristina l’orientamento originale',
	...
	'INCLUDING_SUBALBUMS'               => 'inclusi i sottoalbum',
	...
	'VIEWING_GALLERY'       => 'Visualizza %s',
	'SEARCHING_GALLERY'     => 'Cerca in %s',
	...
	'UPLOAD_EFFECTIVE_LIMIT' => 'Puoi caricare fino a %d immagini in questo gruppo. Il valore considera già i limiti per caricamento, album e utente.',
]);
