...
$lang = array_merge($lang, [
	...
	'ALLOW_COMMENTS_ALL'               => 'Kommentare für alle Bilder erlauben.',
	'ALLOW_COMMENTS_ARY'               => [
	...
	'PHP_SIZE_OVERRUN'      => 'Der Server hat dieses Bild abgelehnt, weil seine Dateigröße das PHP-Upload-Limit von %1$d %2$s überschreitet. Der Serveradministrator sollte <code>upload_max_filesize</code> und bei Bedarf <code>post_max_size</code> in der <code>php.ini</code> erhöhen.',
	'BBCODES'               => 'BBCodes',
	...
	'COMMENTS'                => 'Kommentare',
	'GALLERY_COMMENT_UNAVAILABLE' => 'Kommentare sind für dieses Bild derzeit nicht verfügbar.',
	'GALLERY_RESULTS_HIDDEN'     => 'Die Ergebnisse sind derzeit verborgen.',
	...
	'GALLERY_STATISTICS_EXPLAIN' => 'Gesamt- und Jahresranglisten für Bilder und Alben, die du sehen darfst.',
	'STATISTICS_PERIOD' => 'Zeitraum',
	'STATISTICS_ALL_TIME' => 'Gesamter Zeitraum',
	'STATISTICS_LEGACY_PERIOD' => 'Historische Daten: %1$s – vor %2$s',
	'STATISTICS_PARTIAL_YEAR' => '%1$s (seit %2$s)',
	'STATISTICS_IMAGES' => 'Bilder',
	'STATISTICS_VIEWS' => 'Aufrufe',
	'STATISTICS_DOWNLOADS' => 'Downloads der Originale',
	'STATISTICS_UPLOADERS' => 'Bildautoren',
	'STATISTICS_MOST_VIEWED_IMAGES' => 'Meistgesehene Bilder',
	'STATISTICS_MOST_DOWNLOADED_IMAGES' => 'Meistheruntergeladene Bilder',
	'STATISTICS_TOP_UPLOADERS' => 'Benutzer mit den meisten Bildern',
	'STATISTICS_TOP_DOWNLOADERS' => 'Benutzer mit den meisten Downloads',
	'NO_STATISTICS_DATA' => 'Für diesen Zeitraum sind keine Daten verfügbar.',
	'STATISTICS_ANNUAL_TRACKING_NOTICE' => 'Die jährliche Aufteilung der Aufrufe und Downloads wird seit %s erfasst. Gesamtwerte können frühere Aktivitäten enthalten.',
	'STATISTICS_LEGACY_TRACKING_NOTICE' => 'Dieser Zeitraum fasst Aufrufe und Downloads vor %s zusammen. Die historischen Zähler speicherten keine Datumsangaben und können daher nicht zuverlässig auf einzelne Jahre verteilt werden.',
	'STATISTICS_DOWNLOADER_HISTORY_NOTICE' => 'Frühere Downloads ohne ursprüngliche Benutzerzuordnung können nicht nachträglich zugeordnet werden.',
	...
	'COPY_IMAGE_BBCODE'            => 'Bild-BBCode kopieren',
	'IMAGE_BBCODE_COPIED'          => 'Bild-BBCode kopiert',
	...
	'INVALID_COMMENT'              => 'Ungültiger Kommentar',
	...
	'GALLERY_NEW_IMAGES_COUNT' => [
		0 => 'Keine neuen Bilder',
		1 => '%d neues Bild',
		2 => '%d neue Bilder',
	],
	'NEWEST_PGALLERY'       => 'Unsere neueste persönliche Galerie: %s',
	'NO_ALBUMS'             => 'In dieser Galerie gibt es keine gemeinsamen/öffentlichen Alben.',
	'NO_COMMENTS'           => 'Noch keine Kommentare',
	'NO_IMAGES'             => 'keine Bilder',
	'NO_COMMENTS_NO_IMAGES' => 'Noch keine Kommentare oder eigene Bilder',
	...
	'PERSONAL_ALBUM_IMAGES'  => 'Bilder aus persönlichen Alben',
	'REPORT_IMAGE'      => 'Bild melden',
	'RETURN_ALBUM'      => '%sZurück zum zuletzt besuchten Album%s',
	'APPLY_TRANSFORM_ALL'                 => 'Diese Transformation auf alle Bilder anwenden',
	'FLIP_HORIZONTAL'                    => 'Horizontal spiegeln',
	'FLIP_VERTICAL'                      => 'Vertikal spiegeln',
	'IMAGE_TRANSFORM_ANIMATED_UNSUPPORTED' => 'Animierte GIF-Dateien können nicht transformiert werden, ohne ihre Animation zu verlieren.',
	'IMAGE_TRANSFORM_FAILED'              => 'Das Bild „%s“ konnte nicht transformiert werden. Dafür wurden keine Änderungen gespeichert.',
	'IMAGE_TRANSFORM_FUNCTION'            => 'Dem Server fehlen die für diese Transformation erforderlichen GD-Funktionen.',
	'ORIENTATION_1' => 'Originalausrichtung', 'ORIENTATION_2' => 'Horizontal gespiegelt', 'ORIENTATION_3' => 'Um 180° gedreht', 'ORIENTATION_4' => 'Vertikal gespiegelt',
	'ORIENTATION_5' => 'Nach rechts gedreht und gespiegelt', 'ORIENTATION_6' => 'Nach rechts gedreht', 'ORIENTATION_7' => 'Nach links gedreht und gespiegelt', 'ORIENTATION_8' => 'Nach links gedreht',
	'TRANSFORM_IMAGE' => 'Bild transformieren',
	'TRANSFORM_RESET' => 'Originalausrichtung wiederherstellen',
	...
	'VIEWING_GALLERY'       => 'Betrachtet %s',
	'SEARCHING_GALLERY'     => 'Durchsucht %s',
	'UPLOADING_TO_ALBUM'    => 'Lädt Bilder in das Album %s hoch',

	'WATCH_ALBUM'    => 'Album beobachten',
	'WATCH_ALL_ALBUMS' => 'Alle sichtbaren Alben beobachten',
	'UNWATCH_ALL_ALBUMS' => 'Alle sichtbaren Alben nicht mehr beobachten',
	'WATCH_ALL_ALBUMS_CONFIRM' => 'Möchtest du wirklich alle derzeit sichtbaren Alben beobachten?',
	'UNWATCH_ALL_ALBUMS_CONFIRM' => 'Möchtest du wirklich alle derzeit sichtbaren Alben nicht mehr beobachten?',
	'WATCHING_ALL_ALBUMS' => 'Du wirst jetzt über neue Bilder in allen sichtbaren Alben informiert.',
	'UNWATCHED_ALL_ALBUMS' => 'Du wirst nicht mehr über neue Bilder in den sichtbaren Alben informiert.',
