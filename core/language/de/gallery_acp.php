...
$lang = array_merge($lang, [
	...
	'GALLERY_ADDON_REMOTE_STORAGE_EXPLAIN'   => 'Fügt privaten Remotespeicher bei unterstützten Cloud- und Netzwerkanbietern mit geprüften, fortsetzbaren Migrationen hinzu.',
	...
	'ALBUM_ADMIN_EXPLAIN'               => 'Die phpBB Gallery organisiert öffentliche Inhalte in Kategorien, Alben und verschachtelten Unteralben. Kategorien dienen zum Gruppieren von Inhalten und erlauben keine Bilduploads, während Alben Bilder entsprechend den konfigurierten Berechtigungen aufnehmen. Add-ons können zusätzliche Albumtypen bereitstellen. Hier kannst du Alben erstellen, bearbeiten, löschen, sperren, entsperren und neu anordnen sowie ihre individuellen Einstellungen konfigurieren. Du kannst ein Album auch resynchronisieren, um seine Bildanzahl und die Informationen zum neuesten Bild neu aufzubauen. <strong>Neu erstellte Alben benötigen geeignete Berechtigungen, bevor sie für Benutzer sichtbar sind; du kannst sie manuell zuweisen oder von einem anderen Album kopieren.</strong>',
	...
	'AJAX_LIST_NAVIGATION'         => 'Paginierte Galerie-Listen ohne Neuladen der Seite durchsuchen',
	'AJAX_LIST_NAVIGATION_EXPLAIN' => 'Aktualisiert öffentliche Alben, persönliche Alben oder Unteralben direkt bei Verwendung ihrer Seitennavigation. URL, Browserverlauf und normale Links bleiben erhalten.',
	...
	'ITEMS_PER_PAGE_EXP'       => 'Standardanzahl von Bildern, Kommentaren, Suchergebnissen und Einträgen in Moderations- oder Kontrollbereichen auf paginierten Galerie-Seiten. Begrenzt außerdem die neuesten Kommentare auf der Galerie-Startseite.',
	'ALBUMS_PER_PAGE'          => 'Alben pro Seite',
	'ALBUMS_PER_PAGE_EXP'      => 'Maximale Anzahl sichtbarer Albumeinträge in Listen öffentlicher Alben, persönlicher Alben oder Unteralben. Untergeordnete Alben bleiben ihrem angezeigten übergeordneten Album zugeordnet.',
	...
	'WEBP_QUALITY_EXPLAIN' => 'Legt die WebP-Kodierungsqualität zwischen 0 und 100 fest, wenn vorhandene WebP-Bilder verarbeitet oder WebP-Ableitungen erzeugt werden.',
	...
	'RRC_DISPLAY_IMAGE_TYPE' => 'Bildformat',
	...
	'RRC_DISPLAY_OPTIONS_EXPLAIN' => 'Steuert die Informationen unter den Vorschaubildern in diesem Bereich. Diese Auswahl ist unabhängig von den Schaltern für die einzelne Bildseite.',
	...
	'UPLOAD_IMAGES'      => 'Maximale Bilder pro Upload',
	'UPLOAD_IMAGES_EXPLAIN' => 'Maximale Anzahl von Bilddateien, die in einem einzelnen Upload ausgewählt und gesendet werden können. Dies begrenzt nicht die Gesamtzahl der Bilder im Album.',
