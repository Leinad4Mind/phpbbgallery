...
$lang = array_merge($lang, [
	...
	'PHP_SIZE_OVERRUN'      => 'De server heeft deze afbeelding geweigerd omdat het bestand groter is dan de PHP-uploadlimiet van %1$d %2$s. De serverbeheerder moet <code>upload_max_filesize</code> en indien nodig <code>post_max_size</code> in <code>php.ini</code> verhogen.',
	'BBCODES'               => 'BBCodes',
	...
	'COMMENTS'                => 'Reacties',
	'GALLERY_COMMENT_UNAVAILABLE' => 'Reacties zijn momenteel niet beschikbaar voor deze afbeelding.',
	'GALLERY_RESULTS_HIDDEN'     => 'De resultaten zijn momenteel verborgen.',
	'GALLERY_PRIVATE_IMAGE_DESC' => '<strong>Privéafbeelding</strong> » De afbeeldingsbeschrijving is momenteel verborgen.',
	...
	'REQUEST_IMAGE_DELETION'  => 'Verwijdering aanvragen',
	'DOWNLOAD_SOURCE'         => 'Originele afbeelding downloaden',
	'REQUEST_IMAGE_DELETION_CONFIRM' => 'Weet je zeker dat je verwijdering van deze afbeelding wilt aanvragen?',
	'IMAGE_DELETION_REQUESTED' => 'Het verzoek om de afbeelding te verwijderen is ter moderatie ingediend.',
	...
	'FULL_EDITOR_GALLERY' => 'Volledige bewerker',

	'GALLERY_IMAGE'  => 'Afbeelding',
	'GALLERY_IMAGES' => 'Afbeeldingen',
	'GALLERY_STATISTICS' => 'Galerijstatistieken',
	'GALLERY_STATISTICS_EXPLAIN' => 'Algemene en jaarlijkse ranglijsten voor afbeeldingen en albums die je mag bekijken.',
	'STATISTICS_PERIOD' => 'Periode',
	'STATISTICS_ALL_TIME' => 'Altijd',
	'STATISTICS_LEGACY_PERIOD' => 'Historische gegevens: %1$s – vóór %2$s',
	'STATISTICS_PARTIAL_YEAR' => '%1$s (vanaf %2$s)',
	'STATISTICS_IMAGES' => 'Afbeeldingen',
	'STATISTICS_VIEWS' => 'Weergaven',
	'STATISTICS_DOWNLOADS' => 'Downloads van originelen',
	'STATISTICS_UPLOADERS' => 'Afbeeldingsauteurs',
	'STATISTICS_MOST_VIEWED_IMAGES' => 'Meest bekeken afbeeldingen',
	'STATISTICS_MOST_DOWNLOADED_IMAGES' => 'Meest gedownloade afbeeldingen',
	'STATISTICS_TOP_UPLOADERS' => 'Gebruikers met de meeste afbeeldingen',
	'STATISTICS_TOP_DOWNLOADERS' => 'Gebruikers met de meeste downloads',
	'NO_STATISTICS_DATA' => 'Er zijn geen gegevens beschikbaar voor deze periode.',
	'STATISTICS_ANNUAL_TRACKING_NOTICE' => 'De jaarlijkse verdeling van weergaven en downloads wordt sinds %s bijgehouden. Totalen kunnen eerdere activiteit bevatten.',
	'STATISTICS_LEGACY_TRACKING_NOTICE' => 'Deze periode groepeert weergaven en downloads die vóór %s zijn geregistreerd. De historische tellers bewaarden geen datums en kunnen daarom niet nauwkeurig per jaar worden verdeeld.',
	'STATISTICS_DOWNLOADER_HISTORY_NOTICE' => 'Historische downloads die oorspronkelijk niet aan een lid waren gekoppeld, kunnen niet achteraf worden toegewezen.',
	...
	'COPY_IMAGE_BBCODE'            => 'Afbeeldings-BBCode kopiëren',
	'IMAGE_BBCODE_COPIED'          => 'Afbeeldings-BBCode gekopieerd',
	...
	'IMAGE_UPLOAD_TIME'            => 'Uploaddatum',
	'IMAGE_NOT_EXIST'              => 'Deze afbeelding bestaat niet.',
	'HOTLINK_NOT_ALLOWED'          => 'Direct linken naar afbeeldingen is niet toegestaan.',
	...
	'PERSONAL_ALBUM_IMAGES'  => 'Afbeeldingen uit persoonlijke albums',
	'REPORT_IMAGE'      => 'Meld deze afbeelding',
	'RETURN_ALBUM'      => '%sGa terug naar het laatst bezochte album%s',
	'APPLY_TRANSFORM_ALL' => 'Deze transformatie op alle afbeeldingen toepassen',
	'FLIP_HORIZONTAL' => 'Horizontaal spiegelen', 'FLIP_VERTICAL' => 'Verticaal spiegelen',
	'IMAGE_TRANSFORM_ANIMATED_UNSUPPORTED' => 'Geanimeerde GIF-bestanden kunnen niet worden getransformeerd zonder de animatie te verliezen.',
	'IMAGE_TRANSFORM_FAILED' => 'De afbeelding “%s” kon niet worden getransformeerd. Er zijn hiervoor geen wijzigingen opgeslagen.',
	'IMAGE_TRANSFORM_FUNCTION' => 'De server heeft niet de GD-functies die nodig zijn om deze afbeelding te transformeren.',
	'ORIENTATION_1' => 'Oorspronkelijke stand', 'ORIENTATION_2' => 'Horizontaal gespiegeld', 'ORIENTATION_3' => '180° gedraaid', 'ORIENTATION_4' => 'Verticaal gespiegeld',
	'ORIENTATION_5' => 'Naar rechts gedraaid en gespiegeld', 'ORIENTATION_6' => 'Naar rechts gedraaid', 'ORIENTATION_7' => 'Naar links gedraaid en gespiegeld', 'ORIENTATION_8' => 'Naar links gedraaid',
	'TRANSFORM_IMAGE' => 'Afbeelding transformeren', 'TRANSFORM_RESET' => 'Oorspronkelijke stand herstellen',
	...
	'STATUS'                            => 'Status',
	'SUBALBUMS'                         => 'Subalbums',
	'INCLUDING_SUBALBUMS'               => 'inclusief subalbums',
	'SUBALBUM'                          => 'Subalbum',
