...
$lang = array_merge($lang, [
	...
	'GALLERY_ADDON_REMOTE_STORAGE_EXPLAIN'   => 'Voegt privé externe opslag toe bij ondersteunde cloud- en netwerkproviders, met geverifieerde, hervatbare migraties.',
	...
	'ALBUM_ADMIN_EXPLAIN'               => 'phpBB Gallery organiseert openbare inhoud in categorieën, albums en geneste subalbums. Categorieën worden gebruikt om inhoud te groeperen en accepteren geen afbeeldingsuploads, terwijl albums afbeeldingen accepteren volgens de ingestelde rechten. Add-ons kunnen extra albumtypen aanbieden. Hier kun je albums maken, bewerken, verwijderen, vergrendelen, ontgrendelen en herschikken en hun afzonderlijke instellingen configureren. Je kunt een album ook opnieuw synchroniseren om het aantal afbeeldingen en de informatie over de nieuwste afbeelding opnieuw op te bouwen. <strong>Nieuw gemaakte albums hebben passende rechten nodig voordat ze zichtbaar zijn voor gebruikers; je kunt deze handmatig toewijzen of van een ander album kopiëren.</strong>',
	...
	'AJAX_LIST_NAVIGATION'         => 'Door gepagineerde Galerijlijsten navigeren zonder de pagina opnieuw te laden',
	'AJAX_LIST_NAVIGATION_EXPLAIN' => 'Werkt openbare albums, persoonlijke albums of subalbums ter plaatse bij wanneer hun paginering wordt gebruikt. De URL, browsergeschiedenis en normale koppelingen blijven behouden.',
	...
	'DISP_TOTAL_IMAGES'            => '“Totaal afbeeldingen” weergeven in de statistieken op de forumindex',
	...
	'INDEX_SETTINGS'             => 'Galerij-index — Albums en lay-out',
	...
	'ACP_VIEW_GALLERY_PERMISSIONS_EXPLAIN' => 'Bekijk de effectieve Gallery-permissies van een gebruiker voor een of meer openbare albums of persoonlijke albums. Deze alleen-lezenpagina gebruikt het ingebouwde Ja/Nooit-masker; gebruik het traceerpictogram om de groepen en directe gebruikersinstellingen achter elk booleaans resultaat te bekijken.',
	'GALLERY_PERMISSION_MASK_USER' => 'Gebruiker selecteren',
	'GALLERY_PERMISSION_MASK_USER_EXPLAIN' => 'Voer één geregistreerde gebruikersnaam in of selecteer de anonieme gebruiker.',
	'GALLERY_PERMISSION_MASK_SCOPE' => 'Bereik van Gallery-permissies',
	'GALLERY_PERMISSION_MASK_ALBUMS_EXPLAIN' => 'Selecteer een of meer albums. Houd CTRL (Windows/Linux) of Command (macOS) ingedrukt tijdens het klikken om meerdere albums te selecteren.',
	'GALLERY_EFFECTIVE_PERMISSIONS' => 'Effectieve Gallery-permissies',
	'GALLERY_EFFECTIVE_VALUE' => 'Effectieve waarde',
	...
	'ITEMS_PER_PAGE_EXP'       => 'Standaardaantal afbeeldingen, reacties, zoekresultaten en moderatie- of bedieningspaneelitems op gepagineerde Galerijpagina’s. Beperkt ook de recente reacties op de Galerij-index.',
	'ALBUMS_PER_PAGE'          => 'Albums per pagina',
	'ALBUMS_PER_PAGE_EXP'      => 'Maximaal aantal zichtbare albumitems in elke lijst met openbare albums, persoonlijke albums of subalbums. Onderliggende albums blijven bij hun weergegeven bovenliggende album.',
	...
	'WEBP_QUALITY'      => 'WebP-kwaliteit',
	'WEBP_QUALITY_EXPLAIN' => 'Stelt de WebP-coderingskwaliteit in van 0 tot 100 bij het verwerken van bestaande WebP-afbeeldingen of het genereren van WebP-afgeleiden.',
	...
	'RRC_DISPLAY_IMAGE_TYPE' => 'Afbeeldingstype',
	...
	'RRC_DISPLAY_OPTIONS_EXPLAIN' => 'Bepaalt welke informatie onder de miniaturen in dit onderdeel wordt getoond. Deze keuzes staan los van de opties voor de afzonderlijke afbeeldingspagina.',
	...
	'RRC_GINDEX_MODE'        => 'Blokken',
	'RRC_GINDEX_MODE_EXP'    => 'Het selecteren van willekeurige afbeeldingen kan de laadtijd verhogen bij galerijen met een groot aantal afbeeldingen.',
