...
$lang = array_merge($lang, [
	...
	'GALLERY_ADDON_REMOTE_STORAGE_EXPLAIN'   => 'Ajoute un stockage distant privé auprès des fournisseurs cloud et réseau pris en charge, avec des migrations vérifiées et reprenables.',
	...
	'GALLERY_ADDON_FEATURED_EXPLAIN'         => 'Permet aux modérateurs de sélectionner des images approuvées pour un bloc de cartes ou un diaporama accessible filtré par permissions.',
	...
	'ALBUM_ADMIN_EXPLAIN'               => 'phpBB Gallery organise le contenu public en catégories, albums et sous-albums imbriqués. Les catégories servent à regrouper le contenu et n’acceptent pas l’envoi d’images, tandis que les albums acceptent les images selon les permissions configurées. Des types d’albums supplémentaires peuvent être fournis par des modules complémentaires. Ici, vous pouvez créer, modifier, supprimer, verrouiller, déverrouiller et réorganiser les albums, ainsi que configurer leurs paramètres individuels. Vous pouvez également resynchroniser un album pour reconstruire son nombre d’images et les informations de sa dernière image. <strong>Les albums nouvellement créés nécessitent des permissions appropriées avant d’être visibles par les utilisateurs ; vous pouvez les attribuer manuellement ou les copier depuis un autre album.</strong>',
	...
	'AJAX_LIST_NAVIGATION'         => 'Parcourir les listes paginées de la Galerie sans recharger la page',
	'AJAX_LIST_NAVIGATION_EXPLAIN' => 'Actualise sur place les albums publics, personnels ou sous-albums lors de l’utilisation de leur pagination. L’URL, l’historique du navigateur et les liens normaux sont préservés.',
	...
	'DISP_TOTAL_IMAGES'            => 'Afficher le « Total d\'images » dans les statistiques de l\'index du forum',
	...
	'ITEMS_PER_PAGE_EXP'          => 'Nombre d’images, commentaires, résultats de recherche et entrées de modération ou des panneaux de contrôle affichés par défaut sur les pages de la Galerie. Limite également les commentaires récents affichés sur l’index de la Galerie.',
	'ALBUMS_PER_PAGE'             => 'Albums par page',
	'ALBUMS_PER_PAGE_EXP'         => 'Nombre maximal d’entrées d’album visibles dans chaque liste d’albums publics, personnels ou de sous-albums. Les descendants restent associés à leur parent affiché.',
	...
	'WEBP_QUALITY_EXPLAIN'        => 'Définit la qualité d’encodage WebP entre 0 et 100 lors de la transformation d’images WebP existantes ou de la création de dérivés WebP.',
	...
	'RRC_DISPLAY_IMAGE_TYPE' => 'Type d’image',
	...
	'RRC_DISPLAY_OPTIONS_EXPLAIN' => 'Contrôle les informations affichées sous les miniatures dans cette section. Ces choix sont indépendants des options qui contrôlent la page individuelle de l’image.',
	...
	'RRC_GINDEX_MODE'        => 'Blocs',
	'RRC_GINDEX_MODE_EXP'    => 'La sélection d\'images aléatoires peut augmenter le temps de chargement des galeries contenant un grand nombre d\'images.',
	...
	'RRC_PROFILE_ITEMS'      => 'Images par bloc de profil activé',
