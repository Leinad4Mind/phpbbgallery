...
$lang = array_merge($lang, [
	...
	'DELETE_ALBUM_CONFIRM'           => 'Удалить этот альбом и его пустые вложенные альбомы?',
	'DELETE_ALBUM_REQUIRES_EMPTY'    => 'Нельзя удалить альбомы с опубликованными изображениями или изображениями, ожидающими модерации. Сначала запросите удаление этих изображений и дождитесь решения модератора.',
