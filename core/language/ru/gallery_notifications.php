...
$lang = array_merge($lang, [
	...
	'NOTIFICATION_TYPE_PHPBBGALLERY_IMAGE_NOT_APPROVED' => 'Неодобренные изображения',
	'NOTIFICATION_PHPBBGALLERY_IMAGE_NOT_APPROVED'      => 'Изображения в альбоме <strong>%1$s</strong> не были одобрены',
