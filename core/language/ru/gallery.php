...
$lang = array_merge($lang, [
	...
	'RESIZE_SOURCE_FILESIZE_EXPLAIN' => 'При включённом изменении размера принимаются исходные изображения до %1$s; сохранённое изображение не должно превышать %2$s.',
