...
$lang = array_merge($lang, [
	...
	'DISPLAY_SUBALBUM_ICONS'               => 'Показывать значки подальбомов в родительских альбомах',
	'DISPLAY_SUBALBUM_ICONS_EXPLAIN'       => 'Показывает настроенные значки видимых подальбомов в их родительском альбоме в поддерживаемых представлениях. Подальбомы без значка остаются доступными в виде текстовых ссылок.',
