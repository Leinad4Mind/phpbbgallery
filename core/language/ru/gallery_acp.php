...
$lang = array_merge($lang, [
	...
	'GALLERY_ADDON_SETTINGS_LEGEND_EXPLAIN' => 'Значок звезды отмечает параметры ядра Галереи, добавленные после 3.4.0; значок пазла отмечает параметры, предоставленные дополнениями. Цветовые акценты подчёркивают оба источника. Более ранние параметры ядра остаются без отметки. Выберите значок источника, чтобы показать или скрыть его параметры.',
	'GALLERY_ADDON_SETTINGS_LEGEND_EXPLAIN_SIMPLE' => 'Цветовые акценты отмечают параметры ядра Галереи, добавленные после 3.4.0, и параметры, предоставленные дополнениями. Более ранние параметры ядра остаются без отметки. Выберите значок источника, чтобы показать или скрыть его параметры.',
	'GALLERY_ADDON_SETTINGS_LEGEND_EXPLAIN_HIDDEN' => 'Значки, цветовые акценты и отметки источника у полей отключены. Используйте значки источников ниже, чтобы показать или скрыть их параметры, либо выберите простой или полный режим для восстановления визуальной идентификации.',
	...
	'ALBUM_ICON_PICKER_EXPLAIN'            => 'Выберите один из уже загруженных значков или загрузите новый ниже. Выбор значка автоматически заполняет поле изображения альбома.',
	...
	'NO_ICONS_AVAILABLE'                   => 'Значки ещё не загружены. Загрузите один ниже, чтобы начать.',
	...
	'INDEX_ALBUM_LAYOUT'                   => 'Представление альбомов',
	'INDEX_ALBUM_LAYOUT_EXPLAIN'           => 'Выберите, как показывать альбомы на главной странице Галереи. Эта настройка не изменяет данные альбомов или права доступа.',
	'INDEX_ALBUM_LAYOUT_CLASSIC'           => 'Классический список форума',
	'INDEX_ALBUM_LAYOUT_MODERN'            => 'Современный адаптивный список',
	'INDEX_ALBUM_LAYOUT_CARDS'             => 'Современные карточки',
	'INVALID_INDEX_ALBUM_LAYOUT'           => 'Выбранное представление альбомов недействительно.',
