...
$lang = array_merge($lang, [
	...
	'GALLERY_ADDON_SETTINGS_LEGEND'     => 'Новые параметры ядра и дополнений',
	'GALLERY_ADDON_SETTINGS_LEGEND_EXPLAIN' => 'Значок звезды отмечает параметры ядра Галереи, добавленные после 3.4.0; значок пазла отмечает параметры, предоставленные дополнениями. Цветовые акценты подчёркивают оба источника. Более ранние параметры ядра остаются без отметки.',
	'GALLERY_ADDON_SETTINGS_LEGEND_EXPLAIN_SIMPLE' => 'Цветовые акценты отмечают параметры ядра Галереи, добавленные после 3.4.0, и параметры, предоставленные дополнениями. Более ранние параметры ядра остаются без отметки.',
