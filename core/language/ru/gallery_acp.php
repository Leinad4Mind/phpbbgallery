...
$lang = array_merge($lang, [
	...
	'ACP_VIEW_GALLERY_PERMISSIONS_EXPLAIN' => 'Просмотр действующих прав Галереи, назначенных пользователю для публичного альбома или личных альбомов. Страница доступна только для чтения; значок трассировки показывает группы и прямые настройки пользователя, сформировавшие логический результат.',
