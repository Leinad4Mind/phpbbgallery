...
$lang = array_merge($lang, [
	...
	'CONVERT_COMPLETE_EXPLAIN'       => 'A conversão da sua galeria para o phpBB Gallery v%s foi concluída com sucesso.<br />Confirme que as definições foram transferidas corretamente antes de activar o fórum, eliminando o diretório install.<br /><br /><strong>Observe que as permissões não foram copiadas.</strong><br /><br />Também deverá limpar da banco de dados as entradas antigas cujas imagens estejam em falta. Pode fazê-lo em “.MODs &gt; phpBB Gallery &gt; Limpar galeria”.',
	...
	'FILE_DELETE_FAIL'               => 'Não foi possível excluir o arquivo; terá de o excluir manualmente.',
	'FILE_STILL_EXISTS'              => 'O arquivo ainda existe.',
	'FILES_REQUIRED_EXPLAIN'         => '<strong>Obrigatório</strong> — Para funcionar corretamente, o phpBB Gallery precisa de acessar ou escrever em determinados arquivos ou diretórios. Se vir “Sem permissão de escrita”, altere as permissões do arquivo ou diretório para permitir que o phpBB escreva nele.',
	'FILES_DELETE_OUTDATED'          => 'Excluir arquivos desatualizados',
	'FILES_DELETE_OUTDATED_EXPLAIN'  => 'Ao excluir os arquivos, estes serão removidos definitivamente e não poderão ser restaurados.<br /><br />Observe:<br />Se tiver outros estilos e idiomas instalados, terá de excluir os arquivos manualmente.',
