...
$lang = array_merge($lang, [
	...
	'DELETE_ALBUM_CONFIRM' => 'Да се изтрият този албум и празните му подалбуми?',
	'DELETE_ALBUM_REQUIRES_EMPTY' => 'Албуми с публикувани изображения или изображения, чакащи модерация, не могат да бъдат изтрити. Първо поискайте изтриването на тези изображения и изчакайте модерацията.',
	...
	'RRC_ZEBRA'         => 'Скрий враговете в RRC',
	'RRC_ZEBRA_EXPLAIN' => 'Не показвай изображения от албуми на врагиве в Скорошни, Случайни или Коментари на индекса.<br /><strong>ВНИМАНИЕ!</strong> Това няма да скрива изображения качени в общи/публични албуми.'
]);
