...
$lang = array_merge($lang, [
	...
	'GALLERY_ADDON_SETTINGS_LEGEND'          => 'Нови опции на ядрото и добавките',
	'GALLERY_ADDON_SETTINGS_LEGEND_EXPLAIN'  => 'Значка със звезда обозначава опциите на ядрото на Галерията, добавени след 3.4.0; значка с пъзел обозначава опциите, предоставени от добавки. Отличителните цветове подсилват двата източника. По-старите опции на ядрото остават немаркирани.',
	'GALLERY_ADDON_SETTINGS_LEGEND_EXPLAIN_SIMPLE' => 'Отличителните цветове обозначават опциите на ядрото на Галерията, добавени след 3.4.0, и опциите, предоставени от добавки. По-старите опции на ядрото остават немаркирани.',
