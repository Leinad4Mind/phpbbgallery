...
$lang = array_merge($lang, [
	...
	'ALLOW_COMMENTS_ALL'               => 'Позволи коментарите за всички изображения.',
	'ALLOW_COMMENTS_ARY'               => [
	...
	'GALLERY_RESULTS_HIDDEN'     => 'Резултатите в момента са скрити.',
	...
	'DESC_TOO_LONG'           => 'Описанието ви е твърде дълго',
	'DESCRIPTION_LENGTH'      => 'Въведете описанието си тук; то не може да съдържа повече от <strong>%d</strong> знака.',
	'DETAILS'                 => 'Подробности',
	'DISALLOWED_EXTENSION'    => 'Не разрешено разширение на изборажението',
	'DO_NOT_RATE_IMAGE'       => 'Не оценявай изображението',

	'EDIT_COMMENT'             => 'Редактиране на коментар',
	'EDIT_IMAGE'               => 'Редактиране',
	'IMAGE_EDITED_TIME_TOTAL'  => 'Последно редактирано от %s на %s; общо %d редакция',
	'IMAGE_EDITED_TIMES_TOTAL' => 'Последно редактирано от %s на %s; общо %d редакции',

	'FILE'                       => 'Файл',
	'FILE_SIZE'                  => 'Размер на файла',
	'FILETYPE_MIMETYPE_MISMATCH' => 'Типът на файла „<strong>%1$s</strong>“ не съответства на MIME типа (%2$s).',
	'FILETYPES_GIF'              => 'gif',
	'FILETYPES_JPG'              => 'jpg',
	'FILETYPES_PNG'              => 'png',
	'FILETYPES_WEBP'             => 'webp',
	...
	'FULL_EDITOR_GALLERY' => 'Пълен редактор',

	'GALLERY_IMAGE'  => 'Изображение',
	'GALLERY_IMAGES' => 'Изображения',
	'GALLERY_STATISTICS' => 'Статистика на галерията',
	'GALLERY_STATISTICS_EXPLAIN' => 'Общи и годишни класации за изображенията и албумите, които имате право да виждате.',
	'STATISTICS_PERIOD' => 'Период',
	'STATISTICS_ALL_TIME' => 'За всички времена',
	'STATISTICS_LEGACY_PERIOD' => 'Исторически данни: %1$s – преди %2$s',
	'STATISTICS_PARTIAL_YEAR' => '%1$s (от %2$s)',
	'STATISTICS_IMAGES' => 'Изображения',
	'STATISTICS_VIEWS' => 'Преглеждания',
	'STATISTICS_DOWNLOADS' => 'Изтегляния на оригинали',
	'STATISTICS_UPLOADERS' => 'Автори на изображения',
	'STATISTICS_MOST_VIEWED_IMAGES' => 'Най-преглеждани изображения',
	'STATISTICS_MOST_DOWNLOADED_IMAGES' => 'Най-изтегляни изображения',
	'STATISTICS_TOP_UPLOADERS' => 'Потребители с най-много изображения',
	'STATISTICS_TOP_DOWNLOADERS' => 'Потребители с най-много изтегляния',
	'NO_STATISTICS_DATA' => 'Няма налични данни за този период.',
	'STATISTICS_ANNUAL_TRACKING_NOTICE' => 'Годишната разбивка на преглежданията и изтеглянията се записва от %s. Общите стойности може да включват по-ранна активност.',
	'STATISTICS_LEGACY_TRACKING_NOTICE' => 'Този период обединява преглежданията и изтеглянията, записани преди %s. Историческите броячи не са съхранявали дати и затова не могат да бъдат разделени точно по години.',
	'STATISTICS_DOWNLOADER_HISTORY_NOTICE' => 'Старите изтегляния, които първоначално не са били свързани с потребител, не могат да бъдат приписани със задна дата.',
	...
	'IMAGE_BBCODE'                 => 'BBCode за изображение',
	...
	'COPY_IMAGE_BBCODE'            => 'Копирай BBCode на изображението',
	'IMAGE_BBCODE_COPIED'          => 'BBCode на изображението е копиран',
	'IMAGE_LOCKED'                 => 'Съжаляваме, но това изображение е заключено. Вече не можете да го коментирате.',
	'IMAGE_NAME'                   => 'Име на изображение',
	'IMAGE_UPLOAD_TIME'            => 'Дата на качване',
	'IMAGE_NOT_EXIST'              => 'Това изображение не съществува.',
	'HOTLINK_NOT_ALLOWED'          => 'Директните връзки към изображения не са разрешени.',
	...
	'INVALID_COMMENT'              => 'Невалиден коментар',
	...
	'RESIZE_SOURCE_FILESIZE_EXPLAIN' => 'При включено преоразмеряване Gallery приема оригинален файл до %1$s. Съхраненото преоразмерено изображение не трябва да надвишава %2$s. PHP настройките <code>upload_max_filesize</code> и <code>post_max_size</code> могат да налагат по-нисък лимит.',
	...
	'GALLERY_NEW_IMAGES_COUNT' => [
		0 => 'Няма нови изображения',
		1 => '%d ново изображение',
		2 => '%d нови изображения',
	],
	...
	'NO_COMMENTS_NO_IMAGES' => 'Все още няма коментари или собствени изображения',
	...
	'PERSONAL_ALBUM_IMAGES'  => 'Изображения от лични албуми',
	'REPORT_IMAGE'      => 'Докладвай изображение',
	'RETURN_ALBUM'      => '%sВърни се в последно поетения албум%s',
	'APPLY_TRANSFORM_ALL' => 'Приложи тази трансформация към всички изображения',
	'FLIP_HORIZONTAL' => 'Огледално по хоризонтала', 'FLIP_VERTICAL' => 'Огледално по вертикала',
	'IMAGE_TRANSFORM_ANIMATED_UNSUPPORTED' => 'Анимираните GIF файлове не могат да се трансформират без загуба на анимацията.',
	'IMAGE_TRANSFORM_FAILED' => 'Изображението „%s“ не можа да бъде трансформирано. За него не бяха записани промени.',
	'IMAGE_TRANSFORM_FUNCTION' => 'Сървърът не предоставя GD функциите, необходими за трансформиране на изображението.',
	'ORIENTATION_1' => 'Оригинална ориентация', 'ORIENTATION_2' => 'Огледално по хоризонтала', 'ORIENTATION_3' => 'Завъртяно на 180°', 'ORIENTATION_4' => 'Огледално по вертикала',
	'ORIENTATION_5' => 'Завъртяно надясно и огледално', 'ORIENTATION_6' => 'Завъртяно надясно', 'ORIENTATION_7' => 'Завъртяно наляво и огледално', 'ORIENTATION_8' => 'Завъртяно наляво',
	'TRANSFORM_IMAGE' => 'Трансформиране на изображение', 'TRANSFORM_RESET' => 'Възстанови оригиналната ориентация',
	...
	'SEARCH_IMAGENAME'                  => 'Само имена на изображения',
	...
	'WATCH_ALL_ALBUMS' => 'Абонирай се за всички видими албуми',
	'UNWATCH_ALL_ALBUMS' => 'Отпиши се от всички видими албуми',
	'WATCH_ALL_ALBUMS_CONFIRM' => 'Сигурни ли сте, че искате да се абонирате за всички албуми, които виждате в момента?',
	'UNWATCH_ALL_ALBUMS_CONFIRM' => 'Сигурни ли сте, че искате да се отпишете от всички албуми, които виждате в момента?',
	'WATCHING_ALL_ALBUMS' => 'Вече ще получавате известия за нови изображения във всички видими албуми.',
	'UNWATCHED_ALL_ALBUMS' => 'Вече няма да получавате известия за нови изображения във видимите албуми.',
	...
	'IMAGE_SUBTITLE'          => 'Подзаглавие на изображението',
	'IMAGE_SUBTITLE_EXPLAIN'  => 'По избор. В страницата на изображението подзаглавието може да се използва за търсене на същите думи в галерията.',
	'IMAGE_SUBTITLE_TOO_LONG' => 'Подзаглавието на изображението не може да бъде по-дълго от %d знака.',
	'UPLOAD_EFFECTIVE_LIMIT' => 'Можете да качите до %d изображения в тази група. Стойността вече отчита лимитите за качване, албум и потребител.',
]);
