...
$lang = array_merge($lang, [
	...
	'RESIZE_SOURCE_FILESIZE_EXPLAIN' => 'При включено преоразмеряване се приемат изходни изображения до %1$s; съхраненото изображение трябва да бъде не по-голямо от %2$s.',
