...
$lang = array_merge($lang, [
	...
	'GALLERY_ADDON_SETTINGS_LEGEND_EXPLAIN' => 'A star badge identifies Gallery Core settings added after 3.4.0; a puzzle badge identifies settings supplied by add-ons. Accent colours reinforce both sources. Earlier Core settings remain unmarked. Select a source badge to show or hide its settings.',
	'GALLERY_ADDON_SETTINGS_LEGEND_EXPLAIN_SIMPLE' => 'Accent colours identify Gallery Core settings added after 3.4.0 and settings supplied by add-ons. Earlier Core settings remain unmarked. Select a source badge to show or hide its settings.',
	'GALLERY_ADDON_SETTINGS_LEGEND_EXPLAIN_HIDDEN' => 'Field origin badges, accent colours and markers are off. Use the source badges below to show or hide each source’s settings, or choose Simple or Complete to restore their visual identification.',
