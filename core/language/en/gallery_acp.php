...
$lang = array_merge($lang, [
	...
	'GALLERY_LEGACY_BBCODE_MIGRATE_EXPLAIN' => 'Scans posts, private messages and signatures for the hidden [album] alias. After confirmation, each run converts up to 250 records into %s and keeps phpBB BBCode metadata consistent. Repeat the action until no records remain.',
	'GALLERY_LEGACY_BBCODE_MIGRATE_CONFIRM' => 'Convert the next batch from [album] to %2$s? %1$d records currently remain.',
	'GALLERY_LEGACY_BBCODE_MIGRATE_NONE' => 'No legacy [album] records remain.',
	'GALLERY_LEGACY_BBCODE_MIGRATE_RESULT' => 'Converted %1$d records. %2$d records could not be converted. %3$d records remain.',
