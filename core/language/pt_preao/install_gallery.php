...
$lang = array_merge($lang, [
	...
	'FILES_OUTDATED'                 => 'Ficheiros desactualizados',
	'FILES_OUTDATED_EXPLAIN'         => '<strong>Desactualizado</strong> - De modo a evitar tentativas de intrusão (hacking), por favor remova os seguintes ficheiros.',
	'FOUND_INSTALL'                  => 'Instalação dupla',
	'FOUND_INSTALL_EXPLAIN'          => '<strong>Instalação dupla</strong> - Foi encontrada uma instalação da galeria! Se continuar, os dados existentes serão sobrescritos. Todos os álbuns, imagens e comentários serão eliminados! <strong>Por este motivo é recomendável uma %1$sactualização%2$s.</strong>',
	'FOUND_VERSION'                  => 'Foi encontrada a seguinte versão',
	'FOUNDER_CHECK'                  => 'És "Fundador" deste fórum',
	...
	'STAGE_ADVANCED_EXPLAIN'         => 'Por favor seleccione o módulo principal. Em condições normais não deverá efectuar qualquer alteração.',
