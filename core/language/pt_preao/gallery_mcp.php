...
$lang = array_merge($lang, [
	...
	'EDIT_SELECTED_IMAGES'         => 'Editar imagens seleccionadas',
	'BATCH_EDIT_IMAGES'            => 'Editar imagens seleccionadas',
	'BATCH_EDIT_EXPLAIN'           => 'Reveja o título, o subtítulo e a descrição de cada imagem seleccionada antes de guardar.',
	'BATCH_EDIT_NUMBERING'         => 'Começar a numeração em',
	'BATCH_EDIT_NUMBERING_EXPLAIN' => 'Cada marcador {NUM} num título, subtítulo ou descrição é substituído pelo respectivo número sequencial.',
	...
	'QUEUE_A_APPROVE2_CONFIRM'     => 'Tens a certeza de que pretendes aprovar esta imagem?',
	'QUEUE_A_DELETE'               => 'Eliminar imagem',
	'QUEUE_A_DELETE2'              => 'Eliminar imagem?',
	'QUEUE_A_DELETE2_CONFIRM'      => 'Tens a certeza de que pretendes eliminar esta imagem?',
	'QUEUE_A_LOCK'                 => 'Bloquear comentários da imagem',
	'QUEUE_A_LOCK2'                => 'Aprovar e bloquear os comentários da imagem?',
	'QUEUE_A_LOCK2_CONFIRM'        => 'Tens a certeza de que pretendes aprovar e bloquear os comentários desta imagem?',
	'QUEUE_A_MOVE'                 => 'Mover imagem',
	'QUEUE_A_UNAPPROVE'            => 'Desaprovar imagem',
	'QUEUE_A_UNAPPROVE2'           => 'Desaprovar imagem?',
	'QUEUE_A_UNAPPROVE2_CONFIRM'   => 'Tens a certeza de que pretendes desaprovar esta imagem?',
	...
	'QUEUES_A_APPROVE2_CONFIRM'    => 'Tens a certeza de que pretendes aprovar estas imagens?',
	'QUEUES_A_DELETE'              => 'Eliminar imagens',
	'QUEUES_A_DELETE2'             => 'Eliminar imagens?',
	'QUEUES_A_DELETE2_CONFIRM'     => 'Tens a certeza de que pretendes eliminar estas imagens?',
	'QUEUES_A_LOCK'                => 'Bloquear imagens',
	'QUEUES_A_LOCK2'               => 'Bloquear imagens?',
	'QUEUES_A_LOCK2_CONFIRM'       => 'Tens a certeza de que pretendes bloquear estas imagens?',
	'QUEUES_A_MOVE'                => 'Mover imagens',
	'QUEUES_A_UNAPPROVE'           => 'Desaprovar imagens',
	'QUEUES_A_UNAPPROVE2'          => 'Desaprovar imagens?',
	'QUEUES_A_UNAPPROVE2_CONFIRM'  => 'Tens a certeza de que pretendes desaprovar estas imagens?',
	'QUEUES_A_DISAPPROVE2_CONFIRM' => 'Tens a certeza de que pretendes desaprovar estas imagens?',
	'REPORT_A_CLOSE'               => 'Fechar Reporte',
	'REPORT_A_CLOSE2'              => 'Fechar denúncia?',
	'REPORT_A_CLOSE2_CONFIRM'      => 'Tens a certeza de que pretendes fechar esta denúncia?',
	'REPORT_A_DELETE'              => 'Apagar o Reporte',
	'REPORT_A_DELETE2'             => 'Eliminar denúncia?',
	'REPORT_A_DELETE2_CONFIRM'     => 'Tens a certeza de que pretendes eliminar esta denúncia?',
	'REPORT_A_OPEN'                => 'Abrir Reporte',
	'REPORT_A_OPEN2'               => 'Abrir denúncia?',
	'REPORT_A_OPEN2_CONFIRM'       => 'Tens a certeza de que pretendes abrir esta denúncia?',
	...
	'REPORTS_A_CLOSE2_CONFIRM'     => 'Tens a certeza que queres fechar este(s) reporte(s) de imagem?',
	'REPORTS_A_DELETE'             => 'Apagar Reportes',
	'REPORTS_A_DELETE2'            => 'Deseja Apagar Reportes?',
	'REPORTS_A_DELETE2_CONFIRM'    => 'Tens a certeza que queres eliminar/apagar este(s) reporte(s)?',
	'REPORTS_A_OPEN'               => 'Abrir Reportes',
	'REPORTS_A_OPEN2'              => 'Deseja Abrir Reportes?',
	'REPORTS_A_OPEN2_CONFIRM'      => 'Tens a certeza de que pretendes abrir estas denúncias?',
	'REPORT_MOD'                   => 'Editado e Retificado Por',
	'REPORT_CLOSED_BY'             => 'Reporte Fechado E Oculto Por',
	'REPORTED_IMAGES'              => 'Reportar Imagens',
	'REPORTER'                     => 'Utilizador do Fórum ou Sistema Reportado(a)',
	...
	'WAITING_UNAPPROVED_IMAGE' => [
		...
		'Foi requerida avaliação para a lista de imagens a uma quantia de <strong>%s</strong>, aguarda por moderação.',
	],
	'DELETED_IMAGES' => [
		'Sem imagens eliminadas.',
		'No Total há apenas registo de eliminação ou ficheiro apagado respeitante a <strong>1 Imagem</strong>.',
		'No Total existe já na nossa base e em registo um número correspondente a <strong>%s Imagens e Ficheiros Eliminados</strong>.',
	],
	'MOVED_IMAGES' => [
	...
	'GALLERY_MCP_DELETE_REQUESTS' => 'Pedidos de eliminação de imagens',
	'LATEST_IMAGE_DELETE_REQUESTS' => 'Pedidos de eliminação de imagens mais recentes',
	'DELETE_REQUEST_RESTORE_CONFIRM' => 'Tens a certeza de que queres restaurar as imagens seleccionadas?',
	'QUEUE_STATUS_4' => 'Eliminação solicitada',
	'WAITING_DELETE_REQUESTS' => [
		0 => 'Não existem pedidos de eliminação de imagens a aguardar.',
		1 => 'Existe <span style="font-weight: bold;">1</span> pedido de eliminação de imagem a aguardar.',
		2 => 'Existem <span style="font-weight: bold;">%s</span> pedidos de eliminação de imagens a aguardar.',
	],
	'RESTORED_IMAGES' => [
	...
	'NO_WAITING_DELETE_REQUESTS' => 'Não existem pedidos de eliminação de imagens a aguardar.',
]);
