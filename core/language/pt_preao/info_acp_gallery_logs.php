...
$lang = array_merge($lang, [
	...
	'LOG_ALBUM_DEL_MOVE_IMAGES_ALBUMS' => '<strong>Álbum eliminado e imagens e sub-álbuns movidos</strong> para %1$s<br />» %2$s',	'LOG_ALBUM_DEL_IMAGES' => '<strong>Álbum e as suas imagens eliminados</strong><br />» %s',
	...
	'LOG_GALLERY_APPROVED'             => '<strong>Imagens aprovadas</strong><br />» %s',	'LOG_GALLERY_DELETED' => '<strong>Imagens eliminadas</strong><br />» %s',
	'LOG_GALLERY_DISAPPROVED'          => '<strong>Imagens reprovadas</strong><br />» %s',
	'LOG_GALLERY_EDITED'               => '<strong>Imagens editadas</strong><br />» %s',	'LOG_GALLERY_LOCKED' => '<strong>Imagens bloqueadas</strong><br />» %s',
