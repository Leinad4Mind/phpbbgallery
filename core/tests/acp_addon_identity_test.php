...
final class acp_addon_identity_test extends TestCase
{
	public function test_mixed_acp_settings_are_identified_without_relying_on_colour(): void
	{
		...
		$this->assertStringContainsString('setting.hidden = hiddenSources.indexOf(source) !== -1', $javascript);
		$this->assertStringNotContainsString('filtersEnabled', $javascript);
		...
		$this->assertStringNotContainsString('html[data-gallery-addon-view="hidden"] .gallery-addon-legend__items', $stylesheet);
