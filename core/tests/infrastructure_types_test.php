...
final class infrastructure_types_test extends TestCase
{
	public function test_configuration_defaults_and_mutations(): void
	{
		...
		$this->assertSame('image', $gallery_config->get_bbcode_tag());
		$gallery_config->set('album_bbcode_tag', 'galleryalbum');
		$this->assertSame('galleryalbum', $gallery_config->get_album_bbcode_tag());
		$gallery_config->set('album_bbcode_tag', 'invalid');
		$this->assertSame('album', $gallery_config->get_album_bbcode_tag());
