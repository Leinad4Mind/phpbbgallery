...
final class upload_alternate_author_test extends TestCase
{
	...
	public function test_target_author_drives_quota_finalization_and_notifications(): void
	{
		...
		$this->assertSame(3, substr_count($source, '$this->count_user_images($upload_author_id, $album_id)'));
		$this->assertStringContainsString("WHERE image_user_id = ' . (int) \$user_id", $source);
