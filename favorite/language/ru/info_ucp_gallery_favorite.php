...
$lang = array_merge($lang, [
	...
	'FAVORITE_SHOW_IN_LISTINGS_EXPLAIN' => 'Показывает значок избранного в альбомах и результатах поиска. Если отключено, избранным по-прежнему можно управлять на странице изображения.',
]);
