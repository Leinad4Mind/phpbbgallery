...
$lang = array_merge($lang, [
	...
	'FAVORITE_SHOW_IN_LISTINGS' => 'Показывать элементы избранного в списках изображений',
	'FAVORITE_SHOW_IN_LISTINGS_EXPLAIN' => 'Показывает значок избранного в альбомах, результатах поиска и блоках последних, случайных или избранных изображений. Если отключено, избранным по-прежнему можно управлять на странице изображения.',
]);
