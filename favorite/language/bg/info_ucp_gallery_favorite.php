...
$lang = array_merge($lang, [
	...
	'FAVORITE_SHOW_IN_LISTINGS_EXPLAIN' => 'Показва сърцето за любими в албумите и резултатите от търсенето. Ако е изключено, любимите остават достъпни на страницата на изображението.',
]);
