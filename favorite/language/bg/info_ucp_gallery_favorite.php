...
$lang = array_merge($lang, [
	...
	'FAVORITE_SHOW_IN_LISTINGS' => 'Показване на контролите за любими в списъците с изображения',
	'FAVORITE_SHOW_IN_LISTINGS_EXPLAIN' => 'Показва сърцето за любими в албуми, резултати от търсенето и блокове със скорошни, произволни или избрани изображения. Ако е изключено, любимите остават достъпни на страницата на изображението.',
]);
