...
$lang = array_merge($lang, [
	...
	'ALBUM_NO_TYPE_CHANGE_TO_CONTEST'   => 'An existing regular album cannot be converted into a contest album.',
	'ALBUM_WITH_CONTEST_NO_TYPE_CHANGE' => 'The album type is locked because an existing contest cannot be converted into a regular album.',
	'CONTEST_DATE_EXPLAIN'                => 'Select the date and time. The timezone configured in your phpBB profile is used.',
	'CONTEST_DATE_MUST_BE_FUTURE'         => '%s must be in the future.',
	...
	'CONTEST_END_INVALID'                 => 'Invalid contest end (%s). Select a valid date and time.',
	...
	'CONTEST_RATING_INVALID'              => 'Invalid rating start (%s). Select a valid date and time.',
	...
	'CONTEST_START_INVALID'               => 'Invalid contest start (%s). Select a valid date and time.',
]);
