...
$lang = array_merge($lang, [
	...
	'CONTEST_SCHEMA_OUTDATED'              => 'O esquema da base de dados do add-on Concursos está desatualizado. Executa as migrations do phpBB ou desativa e volta a ativar o add-on antes de criares ou editares um concurso.',
	...
	'CONTEST_DATE_EXPLAIN'                 => 'Seleciona a data e a hora. É usado o fuso horário configurado no teu perfil do phpBB.',
	'CONTEST_DATE_MUST_BE_FUTURE'          => '%s tem de ser uma data e hora futuras.',
	...
	'CONTEST_END_INVALID'                  => 'Fim do concurso inválido (%s). Seleciona uma data e hora válidas.',
	...
	'CONTEST_RATING_INVALID'               => 'Início da votação inválido (%s). Seleciona uma data e hora válidas.',
	...
	'CONTEST_START_INVALID'                => 'Início do concurso inválido (%s). Seleciona uma data e hora válidas.',
]);
