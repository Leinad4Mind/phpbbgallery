...
$lang = array_merge($lang, [
	...
	'CONTEST_SCHEMA_OUTDATED'             => 'Le schéma de base de données du module Concours est obsolète. Exécutez les migrations de phpBB ou désactivez puis réactivez le module avant de créer ou modifier un concours.',
	...
	'CONTEST_DATE_EXPLAIN'                => 'Sélectionnez la date et l’heure. Le fuseau horaire configuré dans votre profil phpBB est utilisé.',
	'CONTEST_DATE_MUST_BE_FUTURE'         => '%s doit être dans le futur.',
	...
	'CONTEST_END_INVALID'                 => 'Fin du concours invalide (%s). Sélectionnez une date et une heure valides.',
	...
	'CONTEST_RATING_INVALID'              => 'Début des votes invalide (%s). Sélectionnez une date et une heure valides.',
	...
	'CONTEST_START_INVALID'               => 'Début du concours invalide (%s). Sélectionnez une date et une heure valides.',
]);
